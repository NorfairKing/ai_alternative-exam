...
\subsection{Acties}
Het hele proces kan beschreven worden een aantal acties die de student kan ondernemen.
\begin{itemize}
\item
...
\end{figure}
\item 
In de keuken kan de student koken en alle overeenkomstige acties daarvoor staan beschreven in figuure \ref{koken}.
\begin{figure}[H]
\centering
\begin{tabular}{|c|c|}
...
\\\vspace{0.25cm}
\begin{tabular}{|c|c|}
    \multicolumn{2}{c}{DraaiSpekOm (DO)}\\
    \hline
    if & In(Keuken)\\
    & Bezet(Pan)\\
    & Bakt(Spek)\\
